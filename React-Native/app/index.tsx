  ...
  return (
    <ScrollView contentContainerStyle={styles.scrollContainer}>
      <View style={styles.Total}>
        <ImageBackground
          source={{ uri: 'https://img.freepik.com/free-photo/different-cosmetics-types-scattered-pink-table_23-2148046961.jpg' }}
          style={styles.image}
        />
...
<View style={styles.formTitle}>
       ...
       />
        ...
        <Text style={styles.listItem}>
          ...
          <Image
            source={{ uri: 'https://as1.ftcdn.net/v2/jpg/05/71/42/92/1000_F_571429278_unuRnmV1ZsEW3vFG2DObxttg1SHK7EeD.jpg' }}
            style={styles.icon}
          />
        ...
        <View style={styles.container}>
          ...
          >
            ...
            <Picker.Item label="Bridal makeup" value="Bridal makeup" />
            <Picker.Item label="Makeup Artist" value="makeup-artist" />
            <Picker.Item label="Makeup consultant" value="Makeup consultant" />
            <Picker.Item label="Cinematic makeup artist" value="Cinematic makeup artist" />
          </Picker>
          ...
          >
            ...
            <Picker.Item label="Grow career" value="Grow career" />
          ...
          >
            ...
            <Picker.Item label="Bangaloe" value="bangalore" />
        ...
        <ImageBackground
          source={{ uri: 'https://imgmedia.lbb.in/media/2023/12/65698cf87f06dd4fb6e9e33e_1701416184916.jpg' }}
